# PDF Direct Editor — Web + Desktop (No Word Conversion)
...
```powershell
npm run dist
# creates release/PDF Direct Editor Setup.exe  (installer)
...
Files generated:
- `release/PDF Direct Editor Setup 1.0.0.exe` — installer (creates Start Menu shortcut)
